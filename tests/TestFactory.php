...
class TestFactory extends \PHPUnit_Framework_TestCase {
    ...
    public function testMetaQueryBetween() {
        ...
        $request = array( $prefix . $meta_key . '1' => 10, $prefix . $meta_key . '2' => 25, $prefix . $meta_key . '3' => 30, );
    ...
    public function testBadMetaKeyRelation() {
        ...
        $this->assertTrue( Relation::_default == $q['meta_query']['relation'] );
    ...
    public function testTaxQueryMultiTax() {
        ...
        $request = array( RequestVar::taxonomy . $tax => array( 'red', 'blue' ), RequestVar::taxonomy . $tax2 => array( 'square', 'circle' ) );
        $f       = new Factory($args, $request );
        $this->assertFalse( $f->hasErrors() );
    ...
    public function testTaxQueryMultiInput() {
        ...
        $request = array( RequestVar::taxonomy . $tax . '1' => 'red', RequestVar::taxonomy . $tax . '2' => array( 'blue', 'green' ) );
        $f       = new Factory( $args, $request );
        $this->assertFalse( $f->hasErrors() );
    ...
    public function testTaxQueryMultiInputEmptyInput() {
        ...
        $request = array( RequestVar::taxonomy . $tax . '1' => 'red', RequestVar::taxonomy . $tax . '2' => array() );
        $f       = new Factory( $args, $request );
        $this->assertFalse( $f->hasErrors() );
