...
class TestInputBuilder extends \WP_UnitTestCase {
    ...
    public function testExcludeWithNestedTaxonomy() {
        ...
        $args = array(
            ...
            'format'      => 'select',
            'nested'      => 'true',
            'exclude'     => array( 'category-one'), // By excluding category-one, its two children should also be excluded.
            'term_format' => 'slug',
        );
    ...
    public function testGenericFieldSelected() {
        ...
        $input = InputBuilder::make( $inputname, FieldType::generic, $args, $request );
